...
/*   Updated: 2022/09/14 17:16:57 by yongmkim         ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
namespace {
	...
	void	_statusCase(ClapTrap const& a, ClapTrap const& b)	{
	...
	void	_attackCase(int& exit_attack_status, ClapTrap& a, ClapTrap& b)	{
		std::string index;
	...
	void	_healCase(int& exit_heal_status, ClapTrap& a, ClapTrap& b)	{
		std::string index;
