...
/*   Updated: 2022/09/14 17:10:44 by yongmkim         ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap&	ClapTrap::operator=(ClapTrap const& operand)	{
	...
	_setName(operand.getName());
	_setHealth(operand.getHealth());
	_setEnergy(operand.getEnergy());
	_setDamage(operand.getDamage());
	return *this;
}
