...
/*   Updated: 2022/09/14 17:49:24 by yongmkim         ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
namespace {
	...
	void	_statusCase(FragTrap const& a, FragTrap const& b)	{
	...
	void	_attackCase(int& exit_attack_status, FragTrap& a, FragTrap& b)	{
		std::string index;
	...
	void	_healCase(int& exit_heal_status, FragTrap& a, FragTrap& b)	{
		std::string index;
